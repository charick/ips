...
//	// The maximum amount of time a connection is allowed to be idle before
//	// being closed.
//	public final static Duration maxIdleTime = Duration.seconds(60);
//
//	// The number of threads dedicated to accepting connections. If omitted,
...
//
//	// The number of unaccepted requests to keep in the accept queue before
//	// refusing connections. If
